...
const ContactDetails: React.FC = () => {
    ...
    const fetchContact = async () => {
      try {
       ...
       if (name) {
         ...
         response = await axios.get(`https://thewire-salvatores-projects-9d7f38e8.vercel.app/api/getContacts?name=${name}`);
       } 
       else if(name === '' || name === null) {
         //response = await axios.get('http://localhost:5000/api/contacts');
         response = await axios.get('https://thewire-salvatores-projects-9d7f38e8.vercel.app/api/getContacts');
       }
       else{
        //response = await axios.get('http://localhost:5000/api/contacts');
        response = await axios.get('https://thewire-salvatores-projects-9d7f38e8.vercel.app/api/getContacts');
  ...
  const deleteContact = async (id: string) => {
    ...
    try {
      ...
      await axios.delete(`https://thewire-salvatores-projects-9d7f38e8.vercel.app/api/deleteContact/${id}`, {
        headers: {
          'x-auth-token' : `${token}`,
        }
      });
